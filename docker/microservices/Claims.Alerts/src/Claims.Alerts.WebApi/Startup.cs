...
using Claims.Alerts.App.Plugin;
using Claims.Alerts.Domain.Plugin;
using Claims.Alerts.Infra.Plugin;
using Claims.Alerts.WebApi.Hubs;
using Claims.Alerts.WebApi.Plugin;
using NetFusion.MongoDB.Plugin;
using NetFusion.RabbitMQ.Plugin;

namespace Claims.Alerts.WebApi
{
